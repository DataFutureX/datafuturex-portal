...
export const works: Work[] = [
  ...
  },
  {
    ...
    screenshots: [
      { src: '/works/wanxiang-hydro/01-portal.png', alt: '演示门户' },
      { src: '/works/wanxiang-hydro/02-login.png', alt: '登录页' },
      { src: '/works/wanxiang-hydro/03-dashboard.png', alt: '监测仪表盘' },
      { src: '/works/wanxiang-hydro/04-map.png', alt: '地图概览' },
      { src: '/works/wanxiang-hydro/05-realtime.png', alt: '实时数据' },
    ],
